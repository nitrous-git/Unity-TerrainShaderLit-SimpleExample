**Unity Terrain Shader Lit — Simple Example**

A small Unity 6.5 URP example showing how to build a custom terrain shader using Unity's new Terrain Shader Lit support in Shader Graph.
The project is intentionally kept simple and is meant as a learning/reference example rather than a complete terrain system or marketplace asset.
